...
necost {
    ...
    legacy_inputs {
        Description = "Optional report-style NE-COST inputs keyed by the original 96 line numbers. Use this for evaluation-group cases whose report tables are easier to preserve as line-number data than as semantic reactor/fuel blocks."
        MinOccurs = 0
        MaxOccurs = 1
        ChildUniqueness = ["case/id"]
        InputTmpl = "sonobject"

        case {
            Description = "One NE-COST island or report input table."
            MinOccurs = 0
            MaxOccurs = NoLimit
            ChildUniqueness = ["input/id"]
            InputTmpl = "sonobject"
            ...
            energy_fraction {
                Description = "Fractional energy weight for this island in the combined LCAE."
                MinOccurs = 0
                MaxOccurs = 1
                ValType = Real
                MinValInc = 0
            ...
            mass_fraction {
                Description = "Mass-fraction weight for this island when the report uses mass weighting."
                MinOccurs = 0
                MaxOccurs = 1
                ValType = Real
                MinValInc = 0
            ...
            input {
                Description = "One original NE-COST input-table line."
                MinOccurs = 0
                MaxOccurs = NoLimit
                InputTmpl = "sonobject"
                ...
                distribution {
                    Description = "0 deterministic, 1 triangular, 2 uniform."
                    MinOccurs = 0
                    MaxOccurs = 1
                    ValType = Int
                    ValEnums = [0 1 2]
                ...
                description {
                    Description = "Report variable description for this line."
                    MinOccurs = 0
                    MaxOccurs = 1
                    ValType = String
                    InputTmpl = "flagtypes"
    ...
    fuel_cycles {
        ...
        cycle {
            ...
            reactor {
                ...
                fleet_capacity {
                    Description = "Fleet capacity of the reactor island in MWe. This is optional when fleet_energy, energy_fraction, or mass_fraction is supplied for weighting."
                    MinOccurs = 0
                    MaxOccurs = 1
                    ValType = Real
                ...
                energy_fraction {
                    Description = "Fractional energy generated by this island in a multi-island LCAE calculation. For example, EG13 uses 0.902 UOX and 0.098 MOX, and EG23 uses 0.954 driver and 0.046 blanket."
                    MinOccurs = 0
                    MaxOccurs = 1
                    ValType = Real
                    MinValInc=0
