...
accert{
    ...
    var{
        ...
        id{
            ...
            MaxOccurs = 1
            ValType = String
            ValEnums =[ REF:user_defined_names REF:pwr_var_names REF:abr_var_names REF:containment_var_names REF:heatpipe_var_names REF:fusion_var_names REF:stellarator_var_names REF:lpsr_var_names REF:mirror_var_names]
        }
        value{
            MinOccurs = 1
            MaxOccurs = 1
                    ...
                    alg{
                        ...
                        var{
                            ...
                            id{
                                ...
                                REF:stellarator_var_names REF:lpsr_var_names REF:mirror_var_names]
                            }
                            value{
                                MinOccurs = 0
                                MaxOccurs = 1
