...
accert{
    ...
    var{
        ...
        unit{
            ...
            MaxOccurs = 1
            ValType = String
            ValEnums = [ MW W lbs ton kg million 'gpm*feet' '1' m 'm^2' 'm^3' 'dollar/m^3' 'dollar/m^2']
        }
    }
    l0COA{
        ...
        l1COA{
            ...
            l2COA{
                ...
                id{
                    ...
                    MaxOccurs = 1
                    ValType = String
                    ValEnums = ['211' '212' '213' '214' '215' '216' '217' '218' '220A' '221' '222' '223' '224' '225' '226' '227' '228' '231' '233' '234' '235' '236' '237' '241' '242' '243' '244' '245' '246' '251' '252' '253' '254' '255' '261' '262' 'new'] 
                    ...
                    alg{
                        ...
                        var{
                            ...
                            unit{
                                ...
                                MaxOccurs = 1
                                ValType = String
                                ValEnums = [ton lbs million "1" "gpm*feet" bar "m^3" "dollar/m^3" MW psi psf dollar thousand]
                            }
                                ...
                                alg{
                                    ...
                                    var{
                                        ...
                                        unit{
                                            ...
                                            MaxOccurs = 1
                                            ValType = String
                                            ValEnums = [ bar lbs ton million "gpm*feet" "1" psi psf]
                                        }
                                    }
                                }
                            }
