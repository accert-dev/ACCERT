...
accert{
    ...
    var{
        ...
        unit{
            ...
            MaxOccurs = 1
            ValType = String
            ValEnums = [squareMeter cubeMeter MW W lbs ton kg million 'gpm*feet' '1' m 'm^2' 'm^3' 'dollar/m^3' 'dollar/m^2']
        }
    }
    l0COA{
