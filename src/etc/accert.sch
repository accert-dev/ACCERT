...
accert{
    ...
    ref_model{
        ...
        InputTmpl = "ref_model"
        ValType = String
        ValEnums = [ "PWR12-BE" "ABR1000" "LFR", "heatpipe","fusion"]
        }            
                ...
                ce{
                    ...
                    alg{
                        ...
                        id{
                            ...
                            MaxOccurs = 1
                            ValType = String
                            ValEnums = [esc_1987 NO_ALG MWth_scale default_0 dev_factor_ref ptn_account MWe_scale sum_multi_accounts fusion_acc211]
                        }
                        var{
                            Description = "changed variable value"
                            MinOccurs = 1
                    ...
                    ce{
                        ...
                        alg{
                            id{
                                ...
                                MaxOccurs = 1
                                ValType = String
                                ValEnums = ['NO_ALG' 'complex' 'unit_weights' 'unit_facility' 'unit_weights_plate' 'unit_weights_factor' 'total_weight_prn' 'esc_1978' 'sum_multi_accounts' 'default_0' 'MWth_scale' 'esc_1987' 'factor_sum' 'unit_volume' 'cost_by_weight' 'fusion_acc211' ]
                            }
                            var{
                                Description = "changed variable value"
                                MinOccurs = 1
