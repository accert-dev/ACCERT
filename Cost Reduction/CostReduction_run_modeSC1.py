...
## ## User-defined Independent Variables (Global Levers)
    ...
    for num_orders in range(1,21):
        ...
        OCC_N_list.append(avg_OCC)
        TCI_N_list.append(avg_TCI)
...
plt.xlabel('Order Book Size', fontsize='25') # x-axis name
