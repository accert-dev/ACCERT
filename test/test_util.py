...
def test_util_methods(cursor):
    ...
    assert ut.extract_affected_abr_cost_elements(cursor)==None
    ...
    assert ut.extract_user_changed_abr_variables(cursor)==None
    assert ut.extract_user_changed_variables(cursor)==None
    assert ut.print_abr_account(cursor)==None
    assert ut.print_abr_cost_element(cursor)==None
    assert ut.print_abr_variable(cursor)==None
    assert ut.print_abr_variable_links(cursor)==None
    ...
    assert ut.print_updated_abr_cost_elements(cursor)==None
