...
The example input is located at ``ACCERT/tutorial/accert/ABR1000.son``.
...
.. code-block:: console
    ...
    > python ../../src/Main.py -i ABR1000.son
...
2. Click on the **file** menu and select **open file**, then navigate to the ``ACCERT/tutorial/accert`` directory and select the ``ABR1000.son`` file.
