...
*       A reference model. (Between the PWR12-BE or the ABR-1000) 
*       The theoretical thermal and electrical output of the desired nuclear reactor. (MW)

.. toctree::
    :maxdepth: 1

    referencemodels.rst
    theoreticalpower.rst
